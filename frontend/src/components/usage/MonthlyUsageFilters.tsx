...
export interface MonthlyUsageFilterValues {
  search: string;
  month: string;
  model: string;
  minCost: string;
...
interface MonthlyUsageFiltersProps {
  filters: MonthlyUsageFilterValues;
  appliedFilters: MonthlyUsageFilterValues;
  onChange: (filters: MonthlyUsageFilterValues) => void;
  onApply: (filters: MonthlyUsageFilterValues) => void;
  onClear: () => void;
  availableModels: string[];
}

export function MonthlyUsageFilters({
  filters,
  appliedFilters,
  onChange,
  onApply,
  onClear,
  availableModels,
}: MonthlyUsageFiltersProps) {
  const modelOptions = [
    { value: '', label: 'All Models' },
    ...availableModels.map((model) => ({ value: model, label: model })),
  ];

  const handleInputChange = (field: keyof MonthlyUsageFilterValues, value: string) => {
