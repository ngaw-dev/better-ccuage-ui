...
export interface CodexMonthlyUsageFilterValues {
  search: string;
  month: string;
  model: string;
  minCost: string;
...
interface CodexMonthlyUsageFiltersProps {
  filters: CodexMonthlyUsageFilterValues;
  appliedFilters: CodexMonthlyUsageFilterValues;
  onChange: (filters: CodexMonthlyUsageFilterValues) => void;
  onApply: (filters: CodexMonthlyUsageFilterValues) => void;
  onClear: () => void;
  availableModels: string[];
}

export function CodexMonthlyUsageFilters({
  filters,
  appliedFilters,
  onChange,
  onApply,
  onClear,
  availableModels,
}: CodexMonthlyUsageFiltersProps) {
  const modelOptions = [
    { value: '', label: 'All Models' },
    ...availableModels.map((model) => ({ value: model, label: model })),
  ];

  const handleInputChange = (field: keyof CodexMonthlyUsageFilterValues, value: string) => {
