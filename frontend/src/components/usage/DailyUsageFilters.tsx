...
export interface DailyUsageFilterValues {
  search: string;
  date: string;
  model: string;
  minCost: string;
...
interface DailyUsageFiltersProps {
  filters: DailyUsageFilterValues;
  appliedFilters: DailyUsageFilterValues;
  onChange: (filters: DailyUsageFilterValues) => void;
  onApply: (filters: DailyUsageFilterValues) => void;
  onClear: () => void;
  availableModels: string[];
}

export function DailyUsageFilters({
  filters,
  appliedFilters,
  onChange,
  onApply,
  ...
  const handleInputChange = (field: keyof DailyUsageFilterValues, value: string) => {
